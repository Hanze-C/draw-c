...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/draw-c
```

A live public deployment of this template is available at [https://draw-c.templates.workers.dev](https://draw-c.templates.workers.dev)
